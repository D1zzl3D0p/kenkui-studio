...
export function SignInPage({ capabilities, client }: { capabilities: Capabilities; client: KenkuiServerClient }) {
  ...
  return <section className="sign-in-panel"><h1>Sign in to your studio</h1><p>Sign in with the email address invited to the beta.</p><a className="primary" href={client.authUrl("login")}>Sign in</a></section>;
}
